...
import { CustomDropdown, CustomDropdownMenu, CustomDropdownItem } from "../components/navbar/Navbar.jsx"
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          <Search className="absolute left-3 top-0 bottom-0 my-auto h-6 w-6 text-muted pointer-events-none" />
          <Input
          ...
          <Card key={bot.id} className="bg-surface-alt border-brand-dark hover:border-surface-alt transition-colors">
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                ...
                >
                  <CustomDropdownMenu className="bg-surface border-surface-alt mt-2 min-w-[140px]">
                    <CustomDropdownItem
                      startContent={<Settings className="h-4 w-4 mr-2" />}
